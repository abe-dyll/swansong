    ...
    <div className="artist-row">
      ...
      {expanded && (
        <div id={panelId} className="artist-row__panel">
            ...
            <div className="artist-row__section-header">
              ...
              {spotifyInfo && spotifyInfo.spotifyUrl && (
                <a href={spotifyInfo.spotifyUrl} target="_blank" rel="noopener noreferrer" className="artist-row__spotify-link">
                  ...
                  <span className="artist-row__spotify-label">SPOTIFY</span>
                </a>
              )}
            </div>
          ...
          <div>
            <div className="artist-row__section-header artist-row__section-header--shows">
              {locationLabel ? `Shows near ${locationLabel}` : 'Upcoming Shows Worldwide'}
            </div>
            {loading && (
              <div className="artist-row__status" role="status">
                <span className="spinner" aria-hidden="true" />
                Searching for shows&hellip;
              </div>
            )}
            {!loading && hasShows && shows.map((s, i) => <ShowCard key={i} show={s} />)}
